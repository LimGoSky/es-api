...
import com.example.esapi.EsApiApplication;
import com.example.esapi.entity.Content;
import com.example.esapi.util.ElasticsearchUtil;
import com.example.esapi.util.HtmlParseUtil;
...
public class ContentService {
    ...
    public Boolean parseContent(String keyword) throws IOException {
        ...
        return esUtil.bulkDocument(EsApiApplication.INDEX_NAME,collect);
    }
...
//        Integer jumpNum = (pageNum-1) * pageSize;
        SearchRequest request = new SearchRequest(EsApiApplication.INDEX_NAME);
